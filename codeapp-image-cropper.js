(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["codeAppImageCropper"] = factory(require("angular"));
	else
		root["codeAppImageCropper"] = factory(root["angular"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ngModule = angular.module('codeAppImageCropper', []);
	
	var Cropper = __webpack_require__(2);
	__webpack_require__(3)(angular, Cropper);
	
	module.exports = 'codeAppImageCropper';
...
/***/ function(module, exports) {
	...
	function Cropper(options) {
	  ...
	  if (!options.imageUrl) {
	    throw new Error('CodeApp-Cropper: No image url given.');
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(angular, Cropper) {
	  ...
	  angular
	    .module('codeAppImageCropper')
	    .directive('codeappImageCropper', function() {
	      return {
	        restrict: 'E',
	        scope: {
	          centerOnInit: '@',
